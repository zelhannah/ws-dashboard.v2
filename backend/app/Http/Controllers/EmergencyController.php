...
class EmergencyController extends Controller
{
    ...
    private const OFFICE_RESET_TOPICS = [
        'office/floor1/system'  => 'RESET',
        'office/floor1/attack'  => 'RESET',
        'office/floor1/buzzerA' => 'OFF',
    ];

    private const WAREHOUSE_RESET_TOPICS = [
        'warehouse/floor2/system'  => 'RESET',
        'warehouse/floor2/attack'  => 'RESET',
        'warehouse/floor2/buzzerB' => 'OFF',
        'warehouse/floor2/alarm'   => 'OFF',
    ];

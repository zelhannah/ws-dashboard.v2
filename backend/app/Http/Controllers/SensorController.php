...
class SensorController extends Controller
{
     ...
     *
     * The actual keyword rules now live in App\Support\SensorStatus so every
     * controller (and the MQTT listener) classifies a reading the exact same
     * way — this method is kept only so existing call sites below don't change.
     */
    private function resolveStatus(?string $value): string
    {
        return SensorStatus::resolve($value);
    }
}
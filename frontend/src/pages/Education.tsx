...
const modules: Module[] = [
    ...
    },
    {
        ...
        body: "Flooding Attack (DoS-style Attack) continuously sends fake danger alerts into the monitoring system. Buzzers repeatedly activate, the dashboard becomes crowded with notifications, and operators experience alert fatigue, making real emergencies difficult to recognize.",
